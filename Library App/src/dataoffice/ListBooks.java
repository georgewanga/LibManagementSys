...
public class ListBooks extends JInternalFrame {
    ...
    private final JLabel northLabel = new JLabel("THE LIST FOR THE BOOKS");
    ...
    private final String DEFAULT_QUERY = "SELECT " + CommonVarriables.COLS_AvailableBooks + " FROM " + CommonVarriables.tablesToCreate[2];

    //constructor of listBooks
    public ListBooks() {
        //for setting the title for the internal frame
        super("List Of Books", false, true, false, true);
        try {
