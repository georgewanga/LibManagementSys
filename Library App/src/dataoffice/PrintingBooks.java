    ...
    public PrintingBooks(String query) {
        ...
        try {
            ...
            while (resultset.next()) {
                textArea.append(
                        CommonVarriables.columnsToAdd[3][4] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][4]) + "\n"
                        + CommonVarriables.columnsToAdd[3][1] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][1]) + "\n"
                        + CommonVarriables.columnsToAdd[3][2] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][2]) + "\n"
                        + CommonVarriables.columnsToAdd[3][3] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][3]) + "\n"
                        + CommonVarriables.columnsToAdd[3][5] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][5]) + "\n"
                        + CommonVarriables.columnsToAdd[3][6] + ": " + resultset.getString(CommonVarriables.columnsToAdd[3][6]) + "\n\n");
            }
            textArea.append("=============== Books Information ===============");
